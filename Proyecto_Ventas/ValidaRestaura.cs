...
{
    public partial class ValidaRestaura : Form
    {
        public ValidaRestaura()
        {
            InitializeComponent();
            titulo.Text = "Ingrese los Datos que acontinuacion se Relacionan \npara comenzar con la Recuperacion...";
        }

        private void ValidaRestaura_Load(object sender, EventArgs e)
        {
